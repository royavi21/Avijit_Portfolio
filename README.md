...
- **JavaScript** for navigation behavior, cursor effects, scroll reveal, and mobile menu interactions
- **Three.js** for the animated hero particle background on the landing section
...
- Sticky navigation bar that adapts on scroll
- Mobile-friendly menu experience with a full-screen overlay
- Portfolio project showcase with interactive hover styles
- About section with skill tags and downloadable resume link
...
- inline JavaScript for page interactions, custom cursor, scroll reveal, and hero animation
